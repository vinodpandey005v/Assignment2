...
struct APIParametersKey {
    static let APIRequestUserId = "userId"
}
...
struct APIResponseKey{
    ...
    static let responseResponseKey = "response"
...
struct Colors {
    ...
    static let selectedCellColorBackgroundColor = UIColor(red: 239.0/255.0, green: 239.0/255.0, blue: 239.0/255.0, alpha: 1.0)
}
